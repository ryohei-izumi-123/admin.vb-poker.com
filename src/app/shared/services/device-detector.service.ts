...
const CONSTANTS: any = {
  ...
  OS_VERSIONS,
  OS_VERSIONS_REGEXP,
  BROWSER_VERSIONS_REGEXP_MAP,
  BROWSER_VERSIONS_REGEXP,
};
...
export class DeviceDetectorService extends BaseService implements OnDestroy {
  /**
   *
   *
   * @private
  ...
  public get isTablet(): boolean {
    return [CONSTANTS.DEVICES.IPAD, CONSTANTS.DEVICES.FIREFOX_OS].some(
   ...
   * @readonly
   * @type {boolean}
   * @returns {boolean} whether the current device is an ios
   * @memberof DeviceDetectorService
   */
   ...
   * @readonly
   * @type {boolean}
   * @returns {boolean} whether the current device is an Android
   * @memberof DeviceDetectorService
   */
  public get isAndroid(): boolean {
    return this._device === CONSTANTS.DEVICES.ANDROID;
  }
  ...
  public get isSafari(): boolean {
    return this._browser === BROWSERS.SAFARI;
  }
  ...
  public get isChrome(): boolean {
    return this._browser === BROWSERS.CHROME;
  }
  ...
  public get isStandalone(): boolean {
    return (
      ('standalone' in window.navigator && _.get(navigator, 'standalone')) ||
